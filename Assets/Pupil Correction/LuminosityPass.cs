...
public class LuminosityPass : ScriptableRendererFeature
{
    ...
    public override void Create()
    {
        ...
        m_CopyFrame.renderPassEvent = RenderPassEvent.AfterRendering; //Frame color is copied late in the frame
